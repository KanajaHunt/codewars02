...
// solution - partially mine - needed to look up answer, but did it from mem and added my authenticity to it

// tolowercase, replace, map - functions I think I will use
function removeRotten(bagOfFruits){
    return bagOfFruits ? bagOfFruits.map((item) => item.includes("rotten") ? item.replace("rotten", "").toLowerCase() : item) : [];
}
